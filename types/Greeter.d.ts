...
interface GreeterInterface extends ethers.utils.Interface {
  ...
  events: {
    'GreetingSet(string)': EventFragment;
  };
...
export class Greeter extends BaseContract {
  ...
  callStatic: {
    ...
    setGreeting(_greeting: string, overrides?: CallOverrides): Promise<boolean>;
  };

  filters: {
    GreetingSet(_greeting?: null): TypedEventFilter<[string], { _greeting: string }>;
  };
